      ...
      <div className="flex w-full max-w-[800px] h-[500px] shadow-lg rounded-2xl overflow-hidden">
        ...
        <div className="w-1/2 bg-white flex flex-col items-center justify-center p-10">
          {activeForm === "signup" ? (
            <>
              ...
              <form className="w-full flex flex-col gap-4">
                ...
                <button
                  ...
                  className="px-8 py-2  rounded-full border border-blue-800 hover:bg-white text-blue-800 w-1/2  flex flex-col justify-items-center transition"
                >
                  SIGN UP
                </button>
              </form>
            ...
            <>
              <h2 className="text-1xl font-bold text-blue-800 mb-6">
              ...
              <form className="w-full flex flex-col gap-4">
                ...
                <button
                  type="button"
                  onClick={() => navigate("/dashboard")}
                  className="px-8 py-2  rounded-full border border-blue-800 hover:bg-white text-blue-800 w-1/2 transition"
                >
                  SIGN IN
                </button>
              </form>
